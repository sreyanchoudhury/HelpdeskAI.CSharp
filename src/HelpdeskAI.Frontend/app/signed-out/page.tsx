  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: 24, margin: 0, marginBottom: 10 }}>You've been signed out</h1>
        <p style={{ fontSize: 14, lineHeight: 1.6, color: "#9098b0", margin: 0, marginBottom: 20 }}>
          Your Microsoft Entra-backed app session has ended. You can sign in again whenever you're ready.
        </p>
        <button
